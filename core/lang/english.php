<?
        	define("lang", "English");
        	define("motd", "Working on it!");
        	define("motd_button", "Play!");

                define("header_play", "Play");
                define("header_stats", "Stats");
                define("header_competitivo", "League");
                define("header_competitivo_equipos", "Teams");
                define("header_competitivo_torneos", "Tournaments");
                define("header_foro", "Forum");
                define("header_tienda", "Shop");
                define("header_menu_cuenta_entrar", "Login");
                define("header_menu_cuenta_registrar", "Register");
                define("header_menu_perfil", "Profile");
                define("header_menu_alertas", "Alerts");
                define("header_menu_solicitudes", "Friendships");
                define("header_menu_reportes", "Reports");
                define("header_menu_apelaciones", "Appeals");
		...
		define("foro_table_tema", "Topic");
		define("foro_table_ultimo", "Last");
		...
		define("foro_topic_button_responder", "Reply");
		define("foro_topic_button_cancelar", "Cancel");
		define("foro_topic_button_editar", "Edit");
		define("foro_topic_button_accion", "Action");
		define("foro_topic_button_accion_borrar", "Hide");
		define("foro_topic_button_accion_editar", "Edit");
 
                define("stats_desc", "best players from the network");
                define("stats_table", "Player");
		...
		define("cuenta_otras_solicitud", "Accept friend requests from other users");
		define("cuenta_otras_pais", "Show my country");
		define("cuenta_otras_server", "Show the server I'm playing on in my profile");
                ...
                define("cuenta_perfil_consecuencia", "Don't try to break out of the box that contains your content.");
                define("cuenta_perfil_button_update", "Update");
				
		define("footer_politicas", "Policies");
		define("footer_politicas_reglas", "Rules");
